"""ShrikeOpenAI - Synchronous OpenAI client wrapper with security scanning."""
...
class ShrikeOpenAI:
    ...
    def scan_file(
        ...
        Example:
            >>> result = client.scan_file("/tmp/config.json", content)
            >>> if result['safe']:
    ...
    def __enter__(self) -> "ShrikeOpenAI":
        return self
...
class _ChatNamespace:
    ...
    def __init__(self, client: ShrikeOpenAI) -> None:
        self._client = client
...
class _CompletionsNamespace:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        # 3. Proxy to OpenAI
        return self._client._openai.chat.completions.create(
